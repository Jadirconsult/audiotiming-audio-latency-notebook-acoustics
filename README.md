...
<div align="center">
  <img src="./public/logo.svg" alt="AudioTiming — Windows audio — Acoustics" width="64" height="64">
  <h1>AudioTiming — Windows audio — Acoustics</h1>
</div>

An independent project specification for Windows audio, covering device format inventory, buffer experiment journal, dropout observation log.
...
<img src="./public/screenshots/desktop-main.svg" alt="Windows audio — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Windows audio — compact concept, not a screenshot" width="250">
<br>
...
- **Device format inventory** — planned module; not implemented.
- **Buffer experiment journal** — planned module; not implemented.
- **Dropout observation log** — planned module; not implemented.

The proposed workflow separates device format inventory from buffer experiment journal, with dropout observation log retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Device format inventory**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="AudioTiming — Windows audio — Acoustics — specification review workflow">
<br>
...
### Device format inventory

Define the input and expected outcome for module 1. Record the Windows audio version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Buffer experiment journal

Define the input and expected outcome for module 2. Record the Windows audio version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Dropout observation log

Define the input and expected outcome for module 3. Record the Windows audio version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Windows audio |
| Category | PC utility specification |
| Input | Manual notes or user-authorized local exports |
| Planned output | Device format inventory |
